...
payments._customerHandlers.payOrder = (data, callback) => {
  if (data.orderId) {
    ...
    // @TODO Check payment methods. If not available, prompt the user to add a payment method using the front-end interface and the Stripe library.

    // @TODO Retrieve payment ID after the payment procedure.
